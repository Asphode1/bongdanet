...
export const leagueFetcher = (url: string) => axios.post(url).then((res) => res.data.data)
...
export default function AdminLeague() {
  ...
  useEffect(() => {
    axios.post('http://football.local.com:80/api/admin/league/all?page=1').then((res) => setMax(res.data.totalPages))
  }, [])
